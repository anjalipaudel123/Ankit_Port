...
const About = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#0a0a0a] min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className={`relative transition-all duration-1000 ${heroVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              <div className="relative">
                {/* Decorative elements */}
                <div className="absolute -top-4 -left-4 w-24 h-24 border-2 border-indigo-200 dark:border-indigo-800 rounded-2xl -z-10" />
                <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-gradient-to-br from-indigo-100 dark:from-indigo-900/50 to-purple-100 dark:to-purple-900/50 rounded-2xl -z-10" />
            ...
            <div className={`lg:pt-8 transition-all duration-1000 delay-200 ${heroVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                <span className="font-semibold text-gray-900 dark:text-white">IAM Intern at Paramount Computer Systems</span> and <span className="font-semibold text-gray-900 dark:text-white">ML Engineer & Backend Developer</span> with 3+ years of experience in cybersecurity, intelligent systems, and scalable backend solutions.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4 mb-8">
                <div className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded-full text-gray-600 dark:text-gray-300">
                  <MapPin className="w-4 h-4" />
                  <span className="text-sm">Kathmandu, Nepal</span>
                </div>
                <a
                  href="mailto:ankit.p@paramountassure.com"
                  className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded-full text-gray-600 dark:text-gray-300 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors"
                >
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-full font-medium hover:bg-gray-800 dark:hover:bg-gray-100 transition-all hover:shadow-lg"
                >
      ...
      <section
        ref={skillsRef}
        className="py-24 px-6 bg-gray-50 dark:bg-white/[0.02]"
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className={`grid sm:grid-cols-2 gap-6 transition-all duration-700 delay-200 ${skillsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            {skills.map((skill, index) => (
              <div
                key={skill.name}
                className="group p-8 bg-gray-50 dark:bg-gray-800/30 rounded-3xl hover:bg-white dark:hover:bg-gray-800/60 hover:shadow-xl transition-all duration-300"
      ...
      <section className="py-10 overflow-hidden">
        <p className="text-center text-xs font-medium text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] mb-6">Tools & technologies I use daily</p>
          ...
          {[...Array(2)].map((_, setIndex) => (
            <div key={setIndex} className="flex items-center gap-4 px-4 shrink-0">
              {[
                ...
                <span
                  key={`${setIndex}-${tool}`}
                  className="inline-flex items-center px-5 py-2.5 rounded-full text-sm font-medium text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors duration-300 cursor-default"
                >
                  {tool}
                </span>
              ))}
          ...
          {[...Array(2)].map((_, setIndex) => (
            <div key={setIndex} className="flex items-center gap-4 px-4 shrink-0">
              {[
                ...
                <span
                  key={`${setIndex}-${tool}`}
                  className="inline-flex items-center px-5 py-2.5 rounded-full text-sm font-medium text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 hover:bg-purple-100 dark:hover:bg-purple-900/50 hover:text-purple-700 dark:hover:text-purple-300 transition-colors duration-300 cursor-default"
                >
                  {tool}
                </span>
              ))}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {experiences.map((exp, index) => (
              <div
                key={index}
                className={`group relative p-8 bg-gray-50 dark:bg-gray-800/30 rounded-3xl hover:bg-white dark:hover:bg-gray-800/60 hover:shadow-xl transition-all duration-500 ${expVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                  }`}
              ...
              >
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-700 rounded-full text-sm text-gray-500 dark:text-gray-300">
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className={`group p-8 bg-gray-50 dark:bg-gray-800/30 rounded-3xl hover:bg-white dark:hover:bg-gray-800/60 hover:shadow-xl transition-all duration-500 ${eduVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '100ms' }}>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">Samriddhi College, Kathmandu</p>
            ...
            <div className={`group p-8 bg-gray-50 dark:bg-gray-800/30 rounded-3xl hover:bg-white dark:hover:bg-gray-800/60 hover:shadow-xl transition-all duration-500 ${eduVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '200ms' }}>
              <div className="flex items-center gap-4 mb-4">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">Sipalaya Infotech</p>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          <div className={`mt-8 flex flex-wrap justify-center gap-3 transition-all duration-700 delay-500 ${creativeVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            {[
              ...
              <span
                key={tool.name}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
              >
      ...
      {/* Footer CTA */}
      <section className="py-24 px-6 bg-gray-900 dark:bg-gray-800/50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-serif text-white mb-6">
            Let's work together
          </h2>
          <p className="text-xl text-gray-400 dark:text-gray-300 mb-10">
      ...
      {/* Footer */}
      <footer className="py-12 px-6 bg-gray-900 dark:bg-gray-800/50 border-t border-gray-800 dark:border-gray-700">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Designed & built by</p>
