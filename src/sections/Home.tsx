...
import { ArrowRight, ArrowUpRight, Download, Github, Linkedin, X, CheckCircle2, Lightbulb, Target, Camera, Film, Play } from 'lucide-react';
    ...
    <div className="bg-white dark:bg-[#0a0a0a]">
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          {/* Inline Live Demo Embed */}
          {showDemo && (
            <div
              ref={demoRef}
              className="mt-16 animate-slide-up"
            >
              <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 shadow-2xl shadow-cyan-500/10 border border-gray-700/50">
                {/* Header bar */}
                <div className="flex items-center justify-between px-6 py-4 bg-gray-900/80 backdrop-blur-sm border-b border-gray-700/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2 ml-2">
                      ...
                      <span className="text-sm font-medium text-gray-300">IELTS Essay Grader — Live Demo</span>
                    </div>
                  </div>
                  <button
                    onClick={() => setShowDemo(false)}
                ...
                {/* Footer */}
                <div className="px-6 py-3 bg-gray-900/80 backdrop-blur-sm border-t border-gray-700/50 flex items-center justify-between">
                  <p className="text-xs text-gray-500">Paste any essay and click "Grade my essay" to see AI-powered scoring in action</p>
                  <span className="text-xs text-gray-600">DeBERTa v3 Large • Gradio</span>
                </div>
              </div>
            </div>
          )}
