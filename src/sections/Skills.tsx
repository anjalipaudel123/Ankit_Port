      ...
      <section id="skills" className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div ref={headerRef} className={`text-center mb-16 transition-all duration-700 ${headerVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className={`mt-4 h-0.5 w-24 mx-auto bg-gradient-to-r from-transparent via-purple-500 to-transparent transition-all duration-1000 delay-300 ${headerVisible ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0'}`} />
          </div>
          ...
          <div ref={tagsRef} className={`mt-16 transition-all duration-700 ${tagsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
